...
public class AdministradorJpaController implements Serializable {
    ...
    public void create(Administrador administrador) {
        ...
        try {
            ...
            Usuario usuarioId = administrador.getUsuarioId();
            if (usuarioId != null) {
            ...
            if (usuarioId != null) {
                usuarioId.getAdministradorList().add(administrador);
    ...
    public void edit(Administrador administrador) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Usuario usuarioIdOld = persistentAdministrador.getUsuarioId();
            Usuario usuarioIdNew = administrador.getUsuarioId();
            if (usuarioIdNew != null) {
                usuarioIdNew = em.getReference(usuarioIdNew.getClass(), usuarioIdNew.getIdUsuario());
                administrador.setUsuarioId(usuarioIdNew);
            }
            administrador = em.merge(administrador);
            if (usuarioIdOld != null && !usuarioIdOld.equals(usuarioIdNew)) {
                usuarioIdOld.getAdministradorList().remove(administrador);
                usuarioIdOld = em.merge(usuarioIdOld);
            }
            if (usuarioIdNew != null && !usuarioIdNew.equals(usuarioIdOld)) {
                usuarioIdNew.getAdministradorList().add(administrador);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Usuario usuarioId = administrador.getUsuarioId();
            if (usuarioId != null) {
                usuarioId.getAdministradorList().remove(administrador);
                usuarioId = em.merge(usuarioId);
            }
